...
const Lists = ({ lists, createList, deleteList, updateList, functions }) => {
    return (
        <div className="h-full w-full py-8 pr-12 flex flex-col gap-12">
            ...
            <PromptHandler functions={functions} placeholder="Make a list of ..." additionalButtons={[<button key="add" onClick={createList}><CiCirclePlus className="stroke-1 text-gray-500 transition-all hover:text-indigo-400" size="1.5rem" /></button>]} />
        </div>
    );
}
